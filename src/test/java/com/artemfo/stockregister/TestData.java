...
public class TestData {
    public static final String URL_TEMPL = "/stock";
    ...
    public static final Stock ST_1_SAME_CODE_ID_1_DELETED = new Stock("12345678", 1, 1, LocalDate.parse("2011-02-02"), "one");
    ...
    public static String JSON_ST_1_SAME_CODE_ID_1_DELETED;
    ...
    static {
        ...
        ST_1_SAME_CODE_ID_1_DELETED.setStatus(StockStatus.DELETED);
        ...
        try {
            ...
            JSON_ST_1_SAME_CODE_ID_1_DELETED = objectMapper.writeValueAsString(ST_1_SAME_CODE_ID_1_DELETED);
